...
//	public void testList() throws Exception {
//		
//		mockMvc.perform(get("/list").param("email","unitTest@test.co.kr")
//									.param("name","unitTestName")
//									.param("phoneNum","0001112222")
//									.param("region","KR")
//									.param("password","123456789")
//									.param("secondPassword","123456789")
//									.param("creDate","new Timestamp(System.currentTimeMillis()).toString()")
//									.param("modDate","new Timestamp(System.currentTimeMillis()).toString()"))
